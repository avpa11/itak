...
class Game extends Component {
  ...
  handleClick(i) {
    ...
    if (this.state.gameFinished !== true) {
      if (
        this.state.stage === "put" &&
        !curElement.classList.contains("reserved")
      ) {
        if (
          (window.sessionStorage.getItem("ownerID") !== null &&
            this.state.turn === "owner") ||
          (window.sessionStorage.getItem("userID") !== null &&
            this.state.turn === "user")
        ) {
          if (
            this.state.activeChip !== undefined &&
            this.state.activeChip !== ""
          ) {
            this.props.firebase
              .gameRoom()
              .where("gameID", "==", window.sessionStorage.getItem("gameID"))
              .get()
                ...
                querySnapshot.forEach(function (doc) {
                  currentComponent.props.firebase
                    ...
                    .update({
                      ...
                      boardSquare0:
                        i === 0
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare0,
                      boardSquare1:
                        i === 1
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare1,
                      boardSquare2:
                        i === 2
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare2,
                      boardSquare3:
                        i === 3
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare3,
                      boardSquare4:
                        i === 4
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare4,
                      boardSquare5:
                        i === 5
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare5,
                      boardSquare6:
                        i === 6
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare6,
                      boardSquare7:
                        i === 7
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare7,
                      boardSquare8:
                        i === 8
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare8,
                      boardSquare9:
                        i === 9
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare9,
                      boardSquare10:
                        i === 10
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare10,
                      boardSquare11:
                        i === 11
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare11,
                      boardSquare12:
                        i === 12
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare12,
                      boardSquare13:
                        i === 13
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare13,
                      boardSquare14:
                        i === 14
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare14,
                      boardSquare15:
                        i === 15
                          ? currentComponent.state.activeChip
                          : currentComponent.state.boardSquare15,
                      chip1:
                        currentComponent.state.activeChip === "chip1"
                          ? i
                          : currentComponent.state.chip1,
                      chip2:
                        currentComponent.state.activeChip === "chip2"
                          ? i
                          : currentComponent.state.chip2,
                      chip3:
                        currentComponent.state.activeChip === "chip3"
                          ? i
                          : currentComponent.state.chip3,
                      chip4:
                        currentComponent.state.activeChip === "chip4"
                          ? i
                          : currentComponent.state.chip4,
                      chip5:
                        currentComponent.state.activeChip === "chip5"
                          ? i
                          : currentComponent.state.chip5,
                      chip6:
                        currentComponent.state.activeChip === "chip6"
                          ? i
                          : currentComponent.state.chip6,
                      chip7:
                        currentComponent.state.activeChip === "chip7"
                          ? i
                          : currentComponent.state.chip7,
                      chip8:
                        currentComponent.state.activeChip === "chip8"
                          ? i
                          : currentComponent.state.chip8,
                      chip9:
                        currentComponent.state.activeChip === "chip9"
                          ? i
                          : currentComponent.state.chip9,
                      chip10:
                        currentComponent.state.activeChip === "chip10"
                          ? i
                          : currentComponent.state.chip10,
                      chip11:
                        currentComponent.state.activeChip === "chip11"
                          ? i
                          : currentComponent.state.chip11,
                      chip12:
                        currentComponent.state.activeChip === "chip12"
                          ? i
                          : currentComponent.state.chip12,
                      chip13:
                        currentComponent.state.activeChip === "chip13"
                          ? i
                          : currentComponent.state.chip13,
                      chip14:
                        currentComponent.state.activeChip === "chip14"
                          ? i
                          : currentComponent.state.chip14,
                      chip15:
                        currentComponent.state.activeChip === "chip15"
                          ? i
                          : currentComponent.state.chip15,
                      chip16:
                        currentComponent.state.activeChip === "chip16"
                          ? i
                          : currentComponent.state.chip16,
                      step: nextStep,
                      stage: "pick",
  ...
  checkForWin(tempArray) {
    ...
    if (bWinning) {
      ...
      if (
        (window.sessionStorage.getItem("ownerID") !== null &&
          currentComponent.state.turn === "owner") ||
        (window.sessionStorage.getItem("userID") !== null &&
          currentComponent.state.turn === "user")
      ) {
        // console.log("You win!");
        strText = "You win!";
      } else {
  ...
  getUpdate() {
    ...
    currentComponent.props.firebase
      ...
      .onSnapshot((querySnapshot) => {
        if (!querySnapshot.empty) {
          querySnapshot.forEach((doc) => {
            currentComponent.setState({
              ...
              boardSquare0:
                doc.data().boardSquare0 !== undefined
                  ? doc.data().boardSquare0
                  : "",
              boardSquare1:
                doc.data().boardSquare1 !== undefined
                  ? doc.data().boardSquare1
                  : "",
              boardSquare2:
                doc.data().boardSquare2 !== undefined
                  ? doc.data().boardSquare2
                  : "",
              boardSquare3:
                doc.data().boardSquare3 !== undefined
                  ? doc.data().boardSquare3
                  : "",
              boardSquare4:
                doc.data().boardSquare4 !== undefined
                  ? doc.data().boardSquare4
                  : "",
              boardSquare5:
                doc.data().boardSquare5 !== undefined
                  ? doc.data().boardSquare5
                  : "",
              boardSquare6:
                doc.data().boardSquare6 !== undefined
                  ? doc.data().boardSquare6
                  : "",
              boardSquare7:
                doc.data().boardSquare7 !== undefined
                  ? doc.data().boardSquare7
                  : "",
              boardSquare8:
                doc.data().boardSquare8 !== undefined
                  ? doc.data().boardSquare8
                  : "",
              boardSquare9:
                doc.data().boardSquare9 !== undefined
                  ? doc.data().boardSquare9
                  : "",
              boardSquare10:
                doc.data().boardSquare10 !== undefined
                  ? doc.data().boardSquare10
                  : "",
              boardSquare11:
                doc.data().boardSquare11 !== undefined
                  ? doc.data().boardSquare11
                  : "",
              boardSquare12:
                doc.data().boardSquare12 !== undefined
                  ? doc.data().boardSquare12
                  : "",
              boardSquare13:
                doc.data().boardSquare13 !== undefined
                  ? doc.data().boardSquare13
                  : "",
              boardSquare14:
                doc.data().boardSquare14 !== undefined
                  ? doc.data().boardSquare14
                  : "",
              boardSquare15:
                doc.data().boardSquare15 !== undefined
                  ? doc.data().boardSquare15
                  : "",
              gameFinished:
                doc.data().gameFinished !== undefined
                  ? doc.data().gameFinished
                  : false,
              docID: doc.id,
            });
          });
        ...
        if (
          currentComponent.state.gameID === "" ||
          currentComponent.state.gameID === null
        ) {
          if (
            document.getElementById("spinner") !== null &&
            document.getElementById("spinner") !== "undefined"
          ) {
            document.getElementById("spinner").remove();
            document.getElementById("spinnerText").innerText =
              "Game with an entered game id does not exist";
            currentComponent.handleShowModal(
              "Game with an entered game id does not exist"
            );
          }
        } else {
          if (currentComponent.state.stage === "pick") {
            if (
              ...
              if (
                document.getElementById("turnSpan") !== null &&
                document.getElementById("turnSpan") !== "undefined"
              ) {
                document.getElementById("turnSpan").style.background =
                  "#7EDF9B";
              }
            } else {
              currentComponent.setState({
          ...
          let i;
          let x;
          const history = currentComponent.state.history.slice(
            0,
            currentComponent.state.stepNumber + 1
          );
          ...
          Object.keys(currentComponent.state).forEach(function (key, index) {
            if (index < 16) {
              ...
              if (document.getElementById(chipID) !== null) {
                ...
                document
                  ...
                  .classList.remove("pendDecision");
              }
            }

            if (boardSquareIDs.includes(key)) {
              if (
                currentComponent.state[key] !== "" &&
                document.getElementById(key) !== null
              ) {
                document.getElementById(key).classList.add("reserved");
                let chipRef = currentComponent.props.firebase.firestore
                  .collection("chips")
                  .doc(currentComponent.state[key]);
                chipRef
                  .get()
                  .then((doc) => {
                    if (doc.exists) {
            ...
            if (currentComponent.state[key] === "pend") {
              if (
                (currentComponent.state.turn === "user" &&
                  window.sessionStorage.getItem("ownerID") !== null &&
                  currentComponent.state.stage === "put") ||
                (currentComponent.state.turn === "owner" &&
                  window.sessionStorage.getItem("userID") !== null &&
                  currentComponent.state.stage === "put")
              ) {
          ...
          // horizontal win
          if (
            this.state.boardSquare0 !== "" &&
            this.state.boardSquare1 !== "" &&
            this.state.boardSquare2 !== "" &&
            this.state.boardSquare3 &&
          ...
          if (
            this.state.boardSquare4 !== "" &&
            this.state.boardSquare5 !== "" &&
            this.state.boardSquare6 !== "" &&
            this.state.boardSquare7 !== "" &&
            this.state.gameFinished === false
          ) {
            tempArray = [];
          ...
          if (
            this.state.boardSquare8 !== "" &&
            this.state.boardSquare9 !== "" &&
            this.state.boardSquare10 !== "" &&
            this.state.boardSquare11 !== "" &&
            this.state.gameFinished === false
          ) {
            tempArray = [];
          ...
          if (
            this.state.boardSquare12 !== "" &&
            this.state.boardSquare13 !== "" &&
            this.state.boardSquare14 !== "" &&
            this.state.boardSquare15 !== "" &&
            this.state.gameFinished === false
          ) {
            tempArray = [];
  ...
  componentDidMount() {
    ...
    if (this._isMounted) {
      ...
      if (
        this.props.location.previouspath === "/new" ||
        this.props.location.previouspath === "/join-friend" ||
        this.props.location.previouspath === "/join-random"
      ) {
        window.sessionStorage.setItem(
          "previouspath",
          this.props.location.previouspath
        );
      ...
      // random join
      if (
        window.sessionStorage.getItem("previouspath") !== null &&
        window.sessionStorage.getItem("previouspath") === "/join-random" &&
        currentComponent.state.gameStarted === false &&
        (window.sessionStorage.getItem("gameID") === null ||
          window.sessionStorage.getItem("gameID") === undefined ||
        ...
        this.props.firebase
          ...
          .then(function (querySnapshot) {
            if (!querySnapshot.empty) {
              ...
              currentComponent.handleShowModal(
                "There are no available public games right now"
              );
            }
          });
      }
      ...
      if (
        window.sessionStorage.getItem("previouspath") !== null &&
        window.sessionStorage.getItem("previouspath") === "/join-friend" &&
        currentComponent.state.gameStarted === false
      ) {
        this.props.firebase
          .gameRoom()
  ...
  handleFigureClick = (e) => {
    ...
    if (this.state.gameFinished !== true) {
      if (
        (currentComponent.state.turn === "owner" &&
          window.sessionStorage.getItem("ownerID") !== null &&
          currentComponent.state.stage === "pick") ||
        (currentComponent.state.turn === "user" &&
          window.sessionStorage.getItem("userID") !== null &&
          currentComponent.state.stage === "pick")
      ) {
            ...
            querySnapshot.forEach(function (doc) {
              ...
              currentComponent.props.firebase
                ...
                .update({
                  ...
                  stage: "put",
                  turn:
                    currentComponent.state.turn === "owner" ? "user" : "owner",
                  [e.target.name]: "pend",
                })
                .then(function () {
                  // console.log("Document successfully updated!");
        ...
        alert(
          "Select a place on the board where to put the highlighted figure"
        );
      } else {
        ...
        <Container className="h-100" id="gameContainer">
          <Row className="h-100">
            <Col md="5">
              ...
              <span
                id="turnSpan"
                className={turnSpanClass}
                style={{ display: turnSpan === "" ? "none" : "initial " }}
              >
                {turnSpan}
              </span>
              <p style={{ fontSize: "20px", paddingTop: "20px" }}>
                {gameStarted === true
                  ? actionText
                  : "Tell you partner the above game ID"}
              </p>
              <React.Fragment>
                <div className="chips">
                  <div>
                    <div className="border-row">
                      ...
                      >
                        {chip1 === "avail" || chip1 === "pend" ? (
                          <img
                            name="chip1"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/1.svg?alt=media&token=1045fc30-e75e-4cfb-8c16-84d9c0b0fa61"
                            className="chipImg small"
                            alt="Chip1"
                            style={{ width: "fit-content" }}
                          />
                        ) : (
                          <div className="chipImg small"></div>
                        )}
                      </button>
                      <button
                        onClick={this.handleFigureClick}
                    ...
                    <div className="border-row">
                      ...
                      >
                        {chip5 === "avail" || chip5 === "pend" ? (
                          <img
                            name="chip5"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/5.svg?alt=media&token=eadd8b90-f531-44c4-8c16-d72ca46b6549"
                            className="chipImg"
                            alt="Chip5"
                            style={{ width: "fit-content" }}
                          />
                      ...
                      >
                        {chip6 === "avail" || chip6 === "pend" ? (
                          <img
                            name="chip6"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/6.svg?alt=media&token=38fff37f-d797-41f8-bb24-fce609b08612"
                            className="chipImg"
                            alt="Chip6"
                            style={{ width: "fit-content" }}
                          />
                      ...
                      >
                        {chip7 === "avail" || chip7 === "pend" ? (
                          <img
                            name="chip7"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/7.svg?alt=media&token=82641bcb-cade-412e-9821-ef4d5778863b"
                            className="chipImg"
                            alt="Chip7"
                            style={{ width: "fit-content" }}
                          />
                      ...
                      >
                        {chip8 === "avail" || chip8 === "pend" ? (
                          <img
                            name="chip8"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/8.svg?alt=media&token=c7e84d24-9485-4df0-bc04-cee2ab41f3ef"
                            className="chipImg"
                            alt="Chip8"
                            style={{ width: "fit-content" }}
                          />
                    ...
                    <div className="border-row">
                      ...
                      >
                        {chip9 === "avail" || chip9 === "pend" ? (
                          <img
                            name="chip9"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/9.svg?alt=media&token=ff831c4a-187e-4107-bd0f-08de56f36aff"
                            className="chipImg small"
                            alt="Chip9"
                            style={{ width: "fit-content" }}
                          />
                      ...
                      >
                        {chip11 === "avail" || chip11 === "pend" ? (
                          <img
                            name="chip11"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/11.svg?alt=media&token=5411bf90-ae2f-4262-8fac-18bae74645ad"
                            className="chipImg small"
                            alt="Chip11"
                            style={{ width: "fit-content" }}
                          />
                      ...
                      >
                        {chip12 === "avail" || chip12 === "pend" ? (
                          <img
                            name="chip12"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/12.svg?alt=media&token=8bc6a465-5b71-4b94-aa8d-060d1cc36777"
                            className="chipImg small"
                            alt="Chip12"
                            style={{ width: "fit-content" }}
                          />
                    ...
                    <div className="border-row">
                      ...
                      >
                        {chip13 === "avail" || chip13 === "pend" ? (
                          <img
                            name="chip13"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/13.svg?alt=media&token=200575e6-22e2-405d-afa8-a715584270d3"
                            className="chipImg"
                            alt="Chip13"
                            style={{ width: "fit-content" }}
                          />
                      ...
                      >
                        {chip14 === "avail" || chip14 === "pend" ? (
                          <img
                            name="chip14"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/14.svg?alt=media&token=b6e78b17-8a89-40d5-b5cf-88dac0912ab1"
                            className="chipImg"
                            alt="Chip14"
                            style={{ width: "fit-content" }}
                          />
                      ...
                      >
                        {chip15 === "avail" || chip15 === "pend" ? (
                          <img
                            name="chip15"
                            src="https://firebasestorage.googleapis.com/v0/b/itak-game.appspot.com/o/15.svg?alt=media&token=8af64269-f755-40ae-b801-6ce043fff73a"
                            className="chipImg"
                            alt="Chip15"
                            style={{ width: "fit-content" }}
                          />
            ...
            <Col md="7">
              {gameStarted === false ? (
                <React.Fragment>
                  ...
                  <p
                    id="spinnerText"
                    style={{ top: "40%", position: "absolute", right: "50%" }}
                  >
